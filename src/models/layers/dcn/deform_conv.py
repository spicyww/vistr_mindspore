...
class TorchDeformConv(nn.Cell):
    def __init__(
        ...
        self.forward_op = ops.Custom(
            "src/models/layers/dcn/ms_dcn.so:ms_deformable_conv_forward", out_shape=lambda x0, x1, x2, x3, x4, x5, x6,
        ...
        self.bprop_input = ops.Custom(
            "src/models/layers/dcn/ms_dcn_bprop.so:msDCN_backward_input", out_shape=lambda x0, x1, x2, x3, x4, x5, x6, x7,
        ...
        self.bprop_filter = ops.Custom(
            "src/models/layers/dcn/ms_dcn_bprop.so:msDCN_backward_filter", out_shape=lambda x0, x1, x2, x3, x4, x5, x6, x7,
            x8, x9, x10, x11, x12, x13, x14, x15, x16, x17: x2, out_dtype=lambda x0, x1, x2, x3, x4, x5, x6, x7,
            x8, x9, x10, x11, x12, x13, x14, x15, x16, x17: x2, func_type="aot")
