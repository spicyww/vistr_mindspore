...
def vistr_r50_infer(args_opt):
    ...
    ann_path = os.path.join(args_opt.dataset_path, "annotations/valid.json")
    ...
    out_file = open(args_opt.save_path, 'w', encoding='utf-8')
...
if __name__ == "__main__":
    ...
    # dataset
    parser.add_argument("--dataset_path", type=str, default="/dataset/VOS")
    parser.add_argument("--pretrained_model", type=str, default="/home/zgz/VisTR/vistr_r50.ckpt")
    parser.add_argument("--device_target", type=int, default=1)
    parser.add_argument("--mean", type=list, default=[0.485, 0.456, 0.406], help='use for img normalize')
    parser.add_argument("--mean", type=list, default=[0.229, 0.224, 0.225], help='usr for img normalize')
